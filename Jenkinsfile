pipeline {
    ...
    environment {
        PROJECT_ID = 'smart-upsc'  // GCP Project ID
        GOOGLE_APPLICATION_CREDENTIALS = credentials('gcp-service-account')  // Service account credentials
        DOCKER_HUB_CREDENTIALS_USR = 'beeram2512'  // Your Docker Hub username
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git branch: 'main', url: 'https://github.com/uniqueupsc/cloudrun-2025.git'
            }
        }
